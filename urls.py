...
urlpatterns = (
    ...
    url(r'^resources/(\d+)/lock/$',views.resource_lock),
    url(r'^resources/(\d+)/unlock/$',views.resource_unlock),
    ...
    url(r'^keycards/(\d+)/set_lockout/$',views.keycard_set_lockout_card),
    url(r'^keycards/(\d+)/unset_lockout/$',views.keycard_unset_lockout_card),
    url(r'^keycards/upload/$',views.keycard_csv_upload),
    url(r'^keycards/create/$',views.keycard_batch_create),
